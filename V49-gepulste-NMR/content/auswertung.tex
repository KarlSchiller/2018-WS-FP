...
Messdaten aus Tabelle \ref{tab:dif}. Grapisch dargestellt ist in Abbildung
\ref{plt:dif} das erste Echo in Abhängigkeit der Pulsabstände und Regression
