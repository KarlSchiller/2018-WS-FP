...
exakt eingestellter Länge des \SI{180}{\degree}-Impulses eine systematische
...
Die Ungenauigkeit der Einstellung des \SI{180}{\degree}-Impulses ist klar in
Abbildung \ref{fig:CP2} zu erkennen.
Für einen größeren Zeitraum addieren sich die Zeitabweichungen des \SI{180}{\degree}-Impulses
