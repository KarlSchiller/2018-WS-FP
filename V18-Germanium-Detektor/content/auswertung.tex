...
% TODO: Bei Tabellen insgesamt noch einmal schauen, ob überall Einheiten heraus dividiert
...
% TODO: Welches Spektrum wurde denn erwartet? Referenz auf Anleitung!
\begin{figure}[htb]
    \centering
...
\end{align*}
\input{build/tables/anleitung_eu.tex}  % TODO: Nachschauen, etwas passt da mit
% dem Header und den wErten nicht. Vermutlich i und W in der Überschrift verwechselt.
\FloatBarrier
...
\end{align*}
bestimmt.
% TODO: Diesen folgenden Text nicht vielleicht in die Diskussion?
...
% \input{build/tables/aktivitaet_ba.tex}  TODO Diese Tabelle muss irgendwie erstellt werden
\FloatBarrier

%-------------------------------------------------------------------------------
\subsection{Identifizierung eines aktiven Nuklids per Spektrum}
\label{sec:Nuklidbestimmung}
% TODO: Den ersten Satz schreibt man eigentlich so nicht. Besser zusammen umformulieren
...
% TODO: Was soll der letzte Satz aussagen? Sinn und Grammatik unklar...
