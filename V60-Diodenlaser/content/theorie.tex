...
Die Aufgaben der einzelen Bestandtteile werden in einem Dioden-Chip und einen
...
bei Untersuchung atomarer Gegebenheiten ($ \approx \SI{5}{\mega\hertz}$).
...
und ein Beugungsgitter (Diffraction Grating) realisiert. Die Linse wird
...
vom anliegenden Anregungsstrom. Zum einen wird die Diode von dem anlilegenden Strom
...
einzelnen Übergängen Dips erkennen und zuordnen.
