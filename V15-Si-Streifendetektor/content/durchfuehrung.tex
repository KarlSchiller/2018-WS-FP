...
Werden alle Bestandteile angeschlossen, so ist der Aufbau wie in Abbildung \ref{fig:aufbau} dargestellt zu erhalten.
\begin{figure}[htb]
  \centering
...
\subsection{Folgen des Yttrium-90 Prozesses}
\label{sec:Yttrium}
